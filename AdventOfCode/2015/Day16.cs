...
public class Day16
{
    ...
    public static ImmutableArray<Sue> LoadSues(string input)
    {
        return input.SplitLines().Select(Sue.FromString).ToImmutableArray();
    }
    ...
    public class Sue
    {
        ...
        public static Sue FromString(string line)
        {
            ...
            var id = int.Parse(name.Remove(0, "Sue ".Length));
