...
public class Day12
{
    ...
    {
        return JsonSerializer.Deserialize<SumAllNumbers>(input).Value;
    }

    [JsonConverter(typeof(CustomSerializer))]
    private struct SumAllNumbers
    {
        ...
        private class CustomSerializer : JsonConverter<SumAllNumbers>
        {
            public override SumAllNumbers Read(ref Utf8JsonReader reader, Type typeToConvert,
